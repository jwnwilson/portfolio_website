                ...
                <div className="flex flex-col md:flex-row items-center">
                    ...
                    <div className="md:w-2/3 mt-5">
                        ...
                        <List type={ListType.number} className="mt-5">
                            ...
                            <li>Launched the highest quality copywriting that stands out in a competitive market</li>
                        ...
                        <List type={ListType.number} className="mt-5">
                            <li>Scaling the team too fast</li>
                            <li>Not validating product markert fit well enough</li>
                        </List>
                    </div>
                </div>
                <Text p>
                    Looking back, here are a lessons that defined our year.
                </Text>
